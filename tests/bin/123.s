...
MAKE_LITERAL_SYMBOL(const_tbl+129)
MAKE_LITERAL_STRING "sym"
MAKE_LITERAL_SYMBOL(const_tbl+152)
MAKE_LITERAL_STRING "str"
MAKE_LITERAL_CHAR(99)
MAKE_LITERAL_PAIR(const_tbl+51,const_tbl+1)
MAKE_LITERAL_PAIR(const_tbl+185,const_tbl+187)
MAKE_LITERAL_PAIR(const_tbl+173,const_tbl+204)
MAKE_LITERAL_PAIR(const_tbl+164,const_tbl+221)
...
copy_stack_loop308:
cmp rsi, 56
je end_copy_stack_loop308
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
add rsi, 8
jmp copy_stack_loop308
end_copy_stack_loop308:
add rsp, rdi
pop rbp
jmp rax
jmp Lexit306
