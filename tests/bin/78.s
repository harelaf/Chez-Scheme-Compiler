...
mov rbx, [rbp + 8 * 2]
cmp rbx, SOB_NIL_ADDRESS
je add_zero_rib_params303

mov rsi, 0 ; i=0
mov rdi, 1 ; j=1
copy_env_loop303:
cmp rsi, -1
je end_copy_env_loop303
mov rcx, [rbx + 8 * rsi]
mov qword [rdx + 8 * rdi], rcx
inc rsi
inc rdi
jmp copy_env_loop303
end_copy_env_loop303:

add_zero_rib_params303:
mov rcx, [rbp + 8 * 3]
shl rcx, 3 ; number of params * 8 bytes
MALLOC rcx, rcx
mov qword [rdx + 8 * 0], rcx
...
copy_params_loop303:
cmp rdi, [rbp + 8 * 3]
je end_copy_params_loop303
mov rbx, [rbp + 8 * (4 + rdi)]
mov qword [rcx + 8 * rdi], rbx
inc rdi
jmp copy_params_loop303
end_copy_params_loop303:
MAKE_CLOSURE(rax, rdx, Lcode303)
jmp Lcont303
Lcode303:
push rbp
mov rbp , rsp
...
copy_stack_loop306:
cmp rsi, 56
je end_copy_stack_loop306
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
add rsi, 8
jmp copy_stack_loop306
end_copy_stack_loop306:
add rsp, rdi
pop rbp
jmp rax
leave
