...
mov rbx, [rbp + 8 * 2]
cmp rbx, SOB_NIL_ADDRESS
je add_zero_rib_params317

mov rsi, 0 ; i=0
mov rdi, 1 ; j=1
copy_env_loop317:
cmp rsi, -1
je end_copy_env_loop317
mov rcx, [rbx + 8 * rsi]
mov qword [rdx + 8 * rdi], rcx
inc rsi
inc rdi
jmp copy_env_loop317
end_copy_env_loop317:

add_zero_rib_params317:
mov rcx, [rbp + 8 * 3]
shl rcx, 3 ; number of params * 8 bytes
MALLOC rcx, rcx
mov qword [rdx + 8 * 0], rcx
...
copy_params_loop317:
cmp rdi, [rbp + 8 * 3]
je end_copy_params_loop317
mov rbx, [rbp + 8 * (4 + rdi)]
mov qword [rcx + 8 * rdi], rbx
inc rdi
jmp copy_params_loop317
end_copy_params_loop317:
MAKE_CLOSURE(rax, rdx, Lcode317)
jmp Lcont317
Lcode317:
push rbp
mov rbp , rsp
...
copy_stack_loop316:
cmp rsi, 56
je end_copy_stack_loop316
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
add rsi, 8
jmp copy_stack_loop316
end_copy_stack_loop316:
add rsp, rdi
pop rbp
jmp rax
leave
...
copy_stack_loop314:
cmp rsi, 56
je end_copy_stack_loop314
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
add rsi, 8
jmp copy_stack_loop314
end_copy_stack_loop314:
add rsp, rdi
pop rbp
jmp rax
leave
...
copy_stack_loop328:
cmp rsi, 56
je end_copy_stack_loop328
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
add rsi, 8
jmp copy_stack_loop328
end_copy_stack_loop328:
add rsp, rdi
pop rbp
jmp rax
leave
...
mov rbx, [rbp + 8 * 2]
cmp rbx, SOB_NIL_ADDRESS
je add_zero_rib_params321

mov rsi, 0 ; i=0
mov rdi, 1 ; j=1
copy_env_loop321:
cmp rsi, -1
je end_copy_env_loop321
mov rcx, [rbx + 8 * rsi]
mov qword [rdx + 8 * rdi], rcx
inc rsi
inc rdi
jmp copy_env_loop321
end_copy_env_loop321:

add_zero_rib_params321:
mov rcx, [rbp + 8 * 3]
shl rcx, 3 ; number of params * 8 bytes
MALLOC rcx, rcx
mov qword [rdx + 8 * 0], rcx
...
copy_params_loop321:
cmp rdi, [rbp + 8 * 3]
je end_copy_params_loop321
mov rbx, [rbp + 8 * (4 + rdi)]
mov qword [rcx + 8 * rdi], rbx
inc rdi
jmp copy_params_loop321
end_copy_params_loop321:
MAKE_CLOSURE(rax, rdx, Lcode321)
jmp Lcont321
Lcode321:
push rbp
mov rbp , rsp
