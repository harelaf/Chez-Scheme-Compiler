...
MAKE_LITERAL_PAIR(const_tbl+51,const_tbl+94)
MAKE_LITERAL_RATIONAL(3,1)
MAKE_LITERAL_FLOAT(4.000000)
MAKE_LITERAL_PAIR(const_tbl+145,const_tbl+1)
MAKE_LITERAL_PAIR(const_tbl+128,const_tbl+154)
MAKE_LITERAL_RATIONAL(5,1)
MAKE_LITERAL_FLOAT(0.600000)
MAKE_LITERAL_PAIR(const_tbl+205,const_tbl+1)
MAKE_LITERAL_PAIR(const_tbl+188,const_tbl+214)
MAKE_LITERAL_RATIONAL(7,1)
MAKE_LITERAL_FLOAT(80.000000)
MAKE_LITERAL_PAIR(const_tbl+265,const_tbl+1)
MAKE_LITERAL_PAIR(const_tbl+248,const_tbl+274)
MAKE_LITERAL_PAIR(const_tbl+291,const_tbl+1)
MAKE_LITERAL_PAIR(const_tbl+231,const_tbl+308)
MAKE_LITERAL_PAIR(const_tbl+171,const_tbl+325)
MAKE_LITERAL_PAIR(const_tbl+111,const_tbl+342)
...
copy_stack_loop302:
cmp rsi, 56
je end_copy_stack_loop302
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
add rsi, 8
jmp copy_stack_loop302
end_copy_stack_loop302:
add rsp, rdi
pop rbp
jmp rax
leave
