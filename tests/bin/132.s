...
mov rbx, [rbp + 8 * 2]
cmp rbx, SOB_NIL_ADDRESS
je add_zero_rib_params323

mov rsi, 0 ; i=0
mov rdi, 1 ; j=1
copy_env_loop323:
cmp rsi, 0
je end_copy_env_loop323
mov rcx, [rbx + 8 * rsi]
mov qword [rdx + 8 * rdi], rcx
inc rsi
inc rdi
jmp copy_env_loop323
end_copy_env_loop323:

add_zero_rib_params323:
mov rcx, [rbp + 8 * 3]
shl rcx, 3 ; number of params * 8 bytes
MALLOC rcx, rcx
mov qword [rdx + 8 * 0], rcx
...
copy_params_loop323:
cmp rdi, [rbp + 8 * 3]
je end_copy_params_loop323
mov rbx, [rbp + 8 * (4 + rdi)]
mov qword [rcx + 8 * rdi], rbx
inc rdi
jmp copy_params_loop323
end_copy_params_loop323:
MAKE_CLOSURE(rax, rdx, Lcode323)
jmp Lcont323
Lcode323:
push rbp
mov rbp , rsp
...
mov rbx, [rbp + 8 * 2]
cmp rbx, SOB_NIL_ADDRESS
je add_zero_rib_params325

mov rsi, 0 ; i=0
mov rdi, 1 ; j=1
copy_env_loop325:
cmp rsi, 0
je end_copy_env_loop325
mov rcx, [rbx + 8 * rsi]
mov qword [rdx + 8 * rdi], rcx
inc rsi
inc rdi
jmp copy_env_loop325
end_copy_env_loop325:

add_zero_rib_params325:
mov rcx, [rbp + 8 * 3]
shl rcx, 3 ; number of params * 8 bytes
MALLOC rcx, rcx
mov qword [rdx + 8 * 0], rcx
...
copy_params_loop325:
cmp rdi, [rbp + 8 * 3]
je end_copy_params_loop325
mov rbx, [rbp + 8 * (4 + rdi)]
mov qword [rcx + 8 * rdi], rbx
inc rdi
jmp copy_params_loop325
end_copy_params_loop325:
MAKE_CLOSURE(rax, rdx, Lcode325)
jmp Lcont325
Lcode325:
push rbp
mov rbp , rsp
...
mov rbx, [rbp + 8 * 2]
cmp rbx, SOB_NIL_ADDRESS
je add_zero_rib_params331

mov rsi, 0 ; i=0
mov rdi, 1 ; j=1
copy_env_loop331:
cmp rsi, 0
je end_copy_env_loop331
mov rcx, [rbx + 8 * rsi]
mov qword [rdx + 8 * rdi], rcx
inc rsi
inc rdi
jmp copy_env_loop331
end_copy_env_loop331:

add_zero_rib_params331:
mov rcx, [rbp + 8 * 3]
shl rcx, 3 ; number of params * 8 bytes
MALLOC rcx, rcx
mov qword [rdx + 8 * 0], rcx
...
copy_params_loop331:
cmp rdi, [rbp + 8 * 3]
je end_copy_params_loop331
mov rbx, [rbp + 8 * (4 + rdi)]
mov qword [rcx + 8 * rdi], rbx
inc rdi
jmp copy_params_loop331
end_copy_params_loop331:
MAKE_CLOSURE(rax, rdx, Lcode331)
jmp Lcont331
Lcode331:
push rbp
mov rbp , rsp
...
mov rbx, [rbp + 8 * 2]
cmp rbx, SOB_NIL_ADDRESS
je add_zero_rib_params336

mov rsi, 0 ; i=0
mov rdi, 1 ; j=1
copy_env_loop336:
cmp rsi, 0
je end_copy_env_loop336
mov rcx, [rbx + 8 * rsi]
mov qword [rdx + 8 * rdi], rcx
inc rsi
inc rdi
jmp copy_env_loop336
end_copy_env_loop336:

add_zero_rib_params336:
mov rcx, [rbp + 8 * 3]
shl rcx, 3 ; number of params * 8 bytes
MALLOC rcx, rcx
mov qword [rdx + 8 * 0], rcx
...
copy_params_loop336:
cmp rdi, [rbp + 8 * 3]
je end_copy_params_loop336
mov rbx, [rbp + 8 * (4 + rdi)]
mov qword [rcx + 8 * rdi], rbx
inc rdi
jmp copy_params_loop336
end_copy_params_loop336:
MAKE_CLOSURE(rax, rdx, Lcode336)
jmp Lcont336
Lcode336:
push rbp
mov rbp , rsp
...
mov rbx, [rbp + 8 * 2]
cmp rbx, SOB_NIL_ADDRESS
je add_zero_rib_params337

mov rsi, 0 ; i=0
mov rdi, 1 ; j=1
copy_env_loop337:
cmp rsi, 0
je end_copy_env_loop337
mov rcx, [rbx + 8 * rsi]
mov qword [rdx + 8 * rdi], rcx
inc rsi
inc rdi
jmp copy_env_loop337
end_copy_env_loop337:

add_zero_rib_params337:
mov rcx, [rbp + 8 * 3]
shl rcx, 3 ; number of params * 8 bytes
MALLOC rcx, rcx
mov qword [rdx + 8 * 0], rcx
...
copy_params_loop337:
cmp rdi, [rbp + 8 * 3]
je end_copy_params_loop337
mov rbx, [rbp + 8 * (4 + rdi)]
mov qword [rcx + 8 * rdi], rbx
inc rdi
jmp copy_params_loop337
end_copy_params_loop337:
MAKE_CLOSURE(rax, rdx, Lcode337)
jmp Lcont337
Lcode337:
push rbp
mov rbp , rsp
...
mov rbx, [rbp + 8 * 2]
cmp rbx, SOB_NIL_ADDRESS
je add_zero_rib_params338

mov rsi, 0 ; i=0
mov rdi, 1 ; j=1
copy_env_loop338:
cmp rsi, 0
je end_copy_env_loop338
mov rcx, [rbx + 8 * rsi]
mov qword [rdx + 8 * rdi], rcx
inc rsi
inc rdi
jmp copy_env_loop338
end_copy_env_loop338:

add_zero_rib_params338:
mov rcx, [rbp + 8 * 3]
shl rcx, 3 ; number of params * 8 bytes
MALLOC rcx, rcx
mov qword [rdx + 8 * 0], rcx
...
copy_params_loop338:
cmp rdi, [rbp + 8 * 3]
je end_copy_params_loop338
mov rbx, [rbp + 8 * (4 + rdi)]
mov qword [rcx + 8 * rdi], rbx
inc rdi
jmp copy_params_loop338
end_copy_params_loop338:
MAKE_CLOSURE(rax, rdx, Lcode338)
jmp Lcont338
Lcode338:
push rbp
mov rbp , rsp
...
mov rbx, [rbp + 8 * 2]
cmp rbx, SOB_NIL_ADDRESS
je add_zero_rib_params342

mov rsi, 0 ; i=0
mov rdi, 1 ; j=1
copy_env_loop342:
cmp rsi, 0
je end_copy_env_loop342
mov rcx, [rbx + 8 * rsi]
mov qword [rdx + 8 * rdi], rcx
inc rsi
inc rdi
jmp copy_env_loop342
end_copy_env_loop342:

add_zero_rib_params342:
mov rcx, [rbp + 8 * 3]
shl rcx, 3 ; number of params * 8 bytes
MALLOC rcx, rcx
mov qword [rdx + 8 * 0], rcx
...
copy_params_loop342:
cmp rdi, [rbp + 8 * 3]
je end_copy_params_loop342
mov rbx, [rbp + 8 * (4 + rdi)]
mov qword [rcx + 8 * rdi], rbx
inc rdi
jmp copy_params_loop342
end_copy_params_loop342:
...
mov rbx, [rbp + 8 * 2]
cmp rbx, SOB_NIL_ADDRESS
je add_zero_rib_params343

mov rsi, 0 ; i=0
mov rdi, 1 ; j=1
copy_env_loop343:
cmp rsi, 0
je end_copy_env_loop343
mov rcx, [rbx + 8 * rsi]
mov qword [rdx + 8 * rdi], rcx
inc rsi
inc rdi
jmp copy_env_loop343
end_copy_env_loop343:

add_zero_rib_params343:
mov rcx, [rbp + 8 * 3]
shl rcx, 3 ; number of params * 8 bytes
MALLOC rcx, rcx
mov qword [rdx + 8 * 0], rcx
...
copy_params_loop343:
cmp rdi, [rbp + 8 * 3]
je end_copy_params_loop343
mov rbx, [rbp + 8 * (4 + rdi)]
mov qword [rcx + 8 * rdi], rbx
inc rdi
jmp copy_params_loop343
end_copy_params_loop343:
MAKE_CLOSURE(rax, rdx, Lcode343)
jmp Lcont343
Lcode343:
push rbp
mov rbp , rsp
...
mov rbx, [rbp + 8 * 2]
cmp rbx, SOB_NIL_ADDRESS
je add_zero_rib_params345

mov rsi, 0 ; i=0
mov rdi, 1 ; j=1
copy_env_loop345:
cmp rsi, 0
je end_copy_env_loop345
mov rcx, [rbx + 8 * rsi]
mov qword [rdx + 8 * rdi], rcx
inc rsi
inc rdi
jmp copy_env_loop345
end_copy_env_loop345:

add_zero_rib_params345:
mov rcx, [rbp + 8 * 3]
shl rcx, 3 ; number of params * 8 bytes
MALLOC rcx, rcx
mov qword [rdx + 8 * 0], rcx
...
copy_params_loop345:
cmp rdi, [rbp + 8 * 3]
je end_copy_params_loop345
mov rbx, [rbp + 8 * (4 + rdi)]
mov qword [rcx + 8 * rdi], rbx
inc rdi
jmp copy_params_loop345
end_copy_params_loop345:
MAKE_CLOSURE(rax, rdx, Lcode345)
jmp Lcont345
Lcode345:
push rbp
mov rbp , rsp
...
mov rbx, [rbp + 8 * 2]
cmp rbx, SOB_NIL_ADDRESS
je add_zero_rib_params347

mov rsi, 0 ; i=0
mov rdi, 1 ; j=1
copy_env_loop347:
cmp rsi, 0
je end_copy_env_loop347
mov rcx, [rbx + 8 * rsi]
mov qword [rdx + 8 * rdi], rcx
inc rsi
inc rdi
jmp copy_env_loop347
end_copy_env_loop347:

add_zero_rib_params347:
mov rcx, [rbp + 8 * 3]
shl rcx, 3 ; number of params * 8 bytes
MALLOC rcx, rcx
mov qword [rdx + 8 * 0], rcx
...
copy_params_loop347:
cmp rdi, [rbp + 8 * 3]
je end_copy_params_loop347
mov rbx, [rbp + 8 * (4 + rdi)]
mov qword [rcx + 8 * rdi], rbx
inc rdi
jmp copy_params_loop347
end_copy_params_loop347:
MAKE_CLOSURE(rax, rdx, Lcode347)
jmp Lcont347
Lcode347:
push rbp
mov rbp , rsp
...
copy_stack_loop349:
cmp rsi, 56
je end_copy_stack_loop349
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
add rsi, 8
jmp copy_stack_loop349
end_copy_stack_loop349:
add rsp, rdi
pop rbp
jmp rax
leave
