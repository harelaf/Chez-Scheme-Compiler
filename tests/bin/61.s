...
mov rcx, [rbp + 8 * 3] ; Number of args on stack
cmp rbx, rcx
je add_nil_to_stack294

adjust_stack_to_list294:
mov rsi, [rbp + 8 * 3]
sub rsi, 0
sub rsi, 1 ; rsi holds the amount of blocks we need to push later
mov rax, SOB_NIL_ADDRESS ; cdr
...
mov rdx, 0
cmp rdx, 0
jne params_length_not_zero294
mov rdx, 1
jmp decided_param_count294
params_length_not_zero294:
mov rdx, rcx
sub rdx, 0
add rdx, 1
decided_param_count294:
mov qword [rbp + 8 * 3], rdx ; updating number of params on stack
dec rcx
add rcx, 4 ; rcx has the offset of the last arg
shl rcx, 3 ; 8*
...
create_list_loop294:
cmp rdi, 0
je end_create_list_loop294
mov rbx, qword [rcx] ; car
MAKE_PAIR(rdx, rbx, rax) ; rdx has new list
mov rax, rdx ; now rax has it ^
sub rcx, 8
dec rdi
jmp create_list_loop294
end_create_list_loop294:
pop rcx ; rcx now points to the last argument on stack
mov qword [rcx], rax ; new list is now in the correct place
; now lets push the stack up
mov rdx, qword [rbp + 8 * 3]
...
push_stack_loop294:
cmp rdi, 0
je end_push_stack_loop294
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
dec rdi
jmp push_stack_loop294
end_push_stack_loop294:
shl rsi, 3 ; push rbp and rsp up
add rbp, rsi
add rsp, rsi
jmp body294
...
mov rbx, [rbp + 8 * 2]
cmp rbx, SOB_NIL_ADDRESS
je add_zero_rib_params296

mov rsi, 0 ; i=0
mov rdi, 1 ; j=1
copy_env_loop296:
cmp rsi, 0
je end_copy_env_loop296
mov rcx, [rbx + 8 * rsi]
mov qword [rdx + 8 * rdi], rcx
inc rsi
inc rdi
jmp copy_env_loop296
end_copy_env_loop296:

add_zero_rib_params296:
mov rcx, [rbp + 8 * 3]
shl rcx, 3 ; number of params * 8 bytes
MALLOC rcx, rcx
mov qword [rdx + 8 * 0], rcx
...
copy_params_loop296:
cmp rdi, [rbp + 8 * 3]
je end_copy_params_loop296
mov rbx, [rbp + 8 * (4 + rdi)]
mov qword [rcx + 8 * rdi], rbx
inc rdi
jmp copy_params_loop296
end_copy_params_loop296:
MAKE_CLOSURE(rax, rdx, Lcode296)
jmp Lcont296
Lcode296:
push rbp
mov rbp , rsp
...
mov rcx, [rbp + 8 * 3] ; Number of args on stack
cmp rbx, rcx
je add_nil_to_stack296

adjust_stack_to_list296:
mov rsi, [rbp + 8 * 3]
sub rsi, 0
sub rsi, 1 ; rsi holds the amount of blocks we need to push later
mov rax, SOB_NIL_ADDRESS ; cdr
...
mov rdx, 0
cmp rdx, 0
jne params_length_not_zero296
mov rdx, 1
jmp decided_param_count296
params_length_not_zero296:
mov rdx, rcx
sub rdx, 0
add rdx, 1
decided_param_count296:
mov qword [rbp + 8 * 3], rdx ; updating number of params on stack
dec rcx
add rcx, 4 ; rcx has the offset of the last arg
shl rcx, 3 ; 8*
...
create_list_loop296:
cmp rdi, 0
je end_create_list_loop296
mov rbx, qword [rcx] ; car
MAKE_PAIR(rdx, rbx, rax) ; rdx has new list
mov rax, rdx ; now rax has it ^
sub rcx, 8
dec rdi
jmp create_list_loop296
end_create_list_loop296:
pop rcx ; rcx now points to the last argument on stack
mov qword [rcx], rax ; new list is now in the correct place
; now lets push the stack up
mov rdx, qword [rbp + 8 * 3]
...
push_stack_loop296:
cmp rdi, 0
je end_push_stack_loop296
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
dec rdi
jmp push_stack_loop296
end_push_stack_loop296:
shl rsi, 3 ; push rbp and rsp up
add rbp, rsi
add rsp, rsi
jmp body296
...
mov rcx, [rbp + 8 * 3] ; Number of args on stack
cmp rbx, rcx
je add_nil_to_stack298

adjust_stack_to_list298:
mov rsi, [rbp + 8 * 3]
sub rsi, 0
sub rsi, 1 ; rsi holds the amount of blocks we need to push later
mov rax, SOB_NIL_ADDRESS ; cdr
...
mov rdx, 0
cmp rdx, 0
jne params_length_not_zero298
mov rdx, 1
jmp decided_param_count298
params_length_not_zero298:
mov rdx, rcx
sub rdx, 0
add rdx, 1
decided_param_count298:
mov qword [rbp + 8 * 3], rdx ; updating number of params on stack
dec rcx
add rcx, 4 ; rcx has the offset of the last arg
shl rcx, 3 ; 8*
...
create_list_loop298:
cmp rdi, 0
je end_create_list_loop298
mov rbx, qword [rcx] ; car
MAKE_PAIR(rdx, rbx, rax) ; rdx has new list
mov rax, rdx ; now rax has it ^
sub rcx, 8
dec rdi
jmp create_list_loop298
end_create_list_loop298:
pop rcx ; rcx now points to the last argument on stack
mov qword [rcx], rax ; new list is now in the correct place
; now lets push the stack up
mov rdx, qword [rbp + 8 * 3]
...
push_stack_loop298:
cmp rdi, 0
je end_push_stack_loop298
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
dec rdi
jmp push_stack_loop298
end_push_stack_loop298:
shl rsi, 3 ; push rbp and rsp up
add rbp, rsi
add rsp, rsi
jmp body298
...
mov rbx, [rbp + 8 * 2]
cmp rbx, SOB_NIL_ADDRESS
je add_zero_rib_params300

mov rsi, 0 ; i=0
mov rdi, 1 ; j=1
copy_env_loop300:
cmp rsi, 2
je end_copy_env_loop300
mov rcx, [rbx + 8 * rsi]
mov qword [rdx + 8 * rdi], rcx
inc rsi
inc rdi
jmp copy_env_loop300
end_copy_env_loop300:

add_zero_rib_params300:
mov rcx, [rbp + 8 * 3]
shl rcx, 3 ; number of params * 8 bytes
MALLOC rcx, rcx
mov qword [rdx + 8 * 0], rcx
...
copy_params_loop300:
cmp rdi, [rbp + 8 * 3]
je end_copy_params_loop300
mov rbx, [rbp + 8 * (4 + rdi)]
mov qword [rcx + 8 * rdi], rbx
inc rdi
jmp copy_params_loop300
end_copy_params_loop300:
MAKE_CLOSURE(rax, rdx, Lcode300)
jmp Lcont300
Lcode300:
push rbp
mov rbp , rsp
...
mov rcx, [rbp + 8 * 3] ; Number of args on stack
cmp rbx, rcx
je add_nil_to_stack300

adjust_stack_to_list300:
mov rsi, [rbp + 8 * 3]
sub rsi, 0
sub rsi, 1 ; rsi holds the amount of blocks we need to push later
mov rax, SOB_NIL_ADDRESS ; cdr
...
mov rdx, 0
cmp rdx, 0
jne params_length_not_zero300
mov rdx, 1
jmp decided_param_count300
params_length_not_zero300:
mov rdx, rcx
sub rdx, 0
add rdx, 1
decided_param_count300:
mov qword [rbp + 8 * 3], rdx ; updating number of params on stack
dec rcx
add rcx, 4 ; rcx has the offset of the last arg
shl rcx, 3 ; 8*
...
create_list_loop300:
cmp rdi, 0
je end_create_list_loop300
mov rbx, qword [rcx] ; car
MAKE_PAIR(rdx, rbx, rax) ; rdx has new list
mov rax, rdx ; now rax has it ^
sub rcx, 8
dec rdi
jmp create_list_loop300
end_create_list_loop300:
pop rcx ; rcx now points to the last argument on stack
mov qword [rcx], rax ; new list is now in the correct place
; now lets push the stack up
mov rdx, qword [rbp + 8 * 3]
...
push_stack_loop300:
cmp rdi, 0
je end_push_stack_loop300
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
dec rdi
jmp push_stack_loop300
end_push_stack_loop300:
shl rsi, 3 ; push rbp and rsp up
add rbp, rsi
add rsp, rsi
jmp body300
...
mov rcx, [rbp + 8 * 3] ; Number of args on stack
cmp rbx, rcx
je add_nil_to_stack302

adjust_stack_to_list302:
mov rsi, [rbp + 8 * 3]
sub rsi, 0
sub rsi, 1 ; rsi holds the amount of blocks we need to push later
mov rax, SOB_NIL_ADDRESS ; cdr
...
mov rdx, 0
cmp rdx, 0
jne params_length_not_zero302
mov rdx, 1
jmp decided_param_count302
params_length_not_zero302:
mov rdx, rcx
sub rdx, 0
add rdx, 1
decided_param_count302:
mov qword [rbp + 8 * 3], rdx ; updating number of params on stack
dec rcx
add rcx, 4 ; rcx has the offset of the last arg
shl rcx, 3 ; 8*
...
create_list_loop302:
cmp rdi, 0
je end_create_list_loop302
mov rbx, qword [rcx] ; car
MAKE_PAIR(rdx, rbx, rax) ; rdx has new list
mov rax, rdx ; now rax has it ^
sub rcx, 8
dec rdi
jmp create_list_loop302
end_create_list_loop302:
pop rcx ; rcx now points to the last argument on stack
mov qword [rcx], rax ; new list is now in the correct place
; now lets push the stack up
mov rdx, qword [rbp + 8 * 3]
...
push_stack_loop302:
cmp rdi, 0
je end_push_stack_loop302
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
dec rdi
jmp push_stack_loop302
end_push_stack_loop302:
shl rsi, 3 ; push rbp and rsp up
add rbp, rsi
add rsp, rsi
jmp body302
...
mov rbx, [rbp + 8 * 2]
cmp rbx, SOB_NIL_ADDRESS
je add_zero_rib_params304

mov rsi, 0 ; i=0
mov rdi, 1 ; j=1
copy_env_loop304:
cmp rsi, 4
je end_copy_env_loop304
mov rcx, [rbx + 8 * rsi]
mov qword [rdx + 8 * rdi], rcx
inc rsi
inc rdi
jmp copy_env_loop304
end_copy_env_loop304:

add_zero_rib_params304:
mov rcx, [rbp + 8 * 3]
shl rcx, 3 ; number of params * 8 bytes
MALLOC rcx, rcx
mov qword [rdx + 8 * 0], rcx
...
copy_params_loop304:
cmp rdi, [rbp + 8 * 3]
je end_copy_params_loop304
mov rbx, [rbp + 8 * (4 + rdi)]
mov qword [rcx + 8 * rdi], rbx
inc rdi
jmp copy_params_loop304
end_copy_params_loop304:
MAKE_CLOSURE(rax, rdx, Lcode304)
jmp Lcont304
Lcode304:
push rbp
mov rbp , rsp
...
mov rcx, [rbp + 8 * 3] ; Number of args on stack
cmp rbx, rcx
je add_nil_to_stack304

adjust_stack_to_list304:
mov rsi, [rbp + 8 * 3]
sub rsi, 0
sub rsi, 1 ; rsi holds the amount of blocks we need to push later
mov rax, SOB_NIL_ADDRESS ; cdr
...
mov rdx, 0
cmp rdx, 0
jne params_length_not_zero304
mov rdx, 1
jmp decided_param_count304
params_length_not_zero304:
mov rdx, rcx
sub rdx, 0
add rdx, 1
decided_param_count304:
mov qword [rbp + 8 * 3], rdx ; updating number of params on stack
dec rcx
add rcx, 4 ; rcx has the offset of the last arg
shl rcx, 3 ; 8*
...
create_list_loop304:
cmp rdi, 0
je end_create_list_loop304
mov rbx, qword [rcx] ; car
MAKE_PAIR(rdx, rbx, rax) ; rdx has new list
mov rax, rdx ; now rax has it ^
sub rcx, 8
dec rdi
jmp create_list_loop304
end_create_list_loop304:
pop rcx ; rcx now points to the last argument on stack
mov qword [rcx], rax ; new list is now in the correct place
; now lets push the stack up
mov rdx, qword [rbp + 8 * 3]
...
push_stack_loop304:
cmp rdi, 0
je end_push_stack_loop304
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
dec rdi
jmp push_stack_loop304
end_push_stack_loop304:
shl rsi, 3 ; push rbp and rsp up
add rbp, rsi
add rsp, rsi
jmp body304
...
mov rcx, [rbp + 8 * 3] ; Number of args on stack
cmp rbx, rcx
je add_nil_to_stack306

adjust_stack_to_list306:
mov rsi, [rbp + 8 * 3]
sub rsi, 0
sub rsi, 1 ; rsi holds the amount of blocks we need to push later
mov rax, SOB_NIL_ADDRESS ; cdr
...
mov rdx, 0
cmp rdx, 0
jne params_length_not_zero306
mov rdx, 1
jmp decided_param_count306
params_length_not_zero306:
mov rdx, rcx
sub rdx, 0
add rdx, 1
decided_param_count306:
mov qword [rbp + 8 * 3], rdx ; updating number of params on stack
dec rcx
add rcx, 4 ; rcx has the offset of the last arg
shl rcx, 3 ; 8*
...
create_list_loop306:
cmp rdi, 0
je end_create_list_loop306
mov rbx, qword [rcx] ; car
MAKE_PAIR(rdx, rbx, rax) ; rdx has new list
mov rax, rdx ; now rax has it ^
sub rcx, 8
dec rdi
jmp create_list_loop306
end_create_list_loop306:
pop rcx ; rcx now points to the last argument on stack
mov qword [rcx], rax ; new list is now in the correct place
; now lets push the stack up
mov rdx, qword [rbp + 8 * 3]
...
push_stack_loop306:
cmp rdi, 0
je end_push_stack_loop306
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
dec rdi
jmp push_stack_loop306
end_push_stack_loop306:
shl rsi, 3 ; push rbp and rsp up
add rbp, rsi
add rsp, rsi
jmp body306
...
mov rcx, [rbp + 8 * 3] ; Number of args on stack
cmp rbx, rcx
je add_nil_to_stack308

adjust_stack_to_list308:
mov rsi, [rbp + 8 * 3]
sub rsi, 0
sub rsi, 1 ; rsi holds the amount of blocks we need to push later
mov rax, SOB_NIL_ADDRESS ; cdr
...
mov rdx, 0
cmp rdx, 0
jne params_length_not_zero308
mov rdx, 1
jmp decided_param_count308
params_length_not_zero308:
mov rdx, rcx
sub rdx, 0
add rdx, 1
decided_param_count308:
mov qword [rbp + 8 * 3], rdx ; updating number of params on stack
dec rcx
add rcx, 4 ; rcx has the offset of the last arg
shl rcx, 3 ; 8*
...
create_list_loop308:
cmp rdi, 0
je end_create_list_loop308
mov rbx, qword [rcx] ; car
MAKE_PAIR(rdx, rbx, rax) ; rdx has new list
mov rax, rdx ; now rax has it ^
sub rcx, 8
dec rdi
jmp create_list_loop308
end_create_list_loop308:
pop rcx ; rcx now points to the last argument on stack
mov qword [rcx], rax ; new list is now in the correct place
; now lets push the stack up
mov rdx, qword [rbp + 8 * 3]
...
push_stack_loop308:
cmp rdi, 0
je end_push_stack_loop308
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
dec rdi
jmp push_stack_loop308
end_push_stack_loop308:
shl rsi, 3 ; push rbp and rsp up
add rbp, rsi
add rsp, rsi
jmp body308
...
mov rbx, [rbp + 8 * 2]
cmp rbx, SOB_NIL_ADDRESS
je add_zero_rib_params310

mov rsi, 0 ; i=0
mov rdi, 1 ; j=1
copy_env_loop310:
cmp rsi, 7
je end_copy_env_loop310
mov rcx, [rbx + 8 * rsi]
mov qword [rdx + 8 * rdi], rcx
inc rsi
inc rdi
jmp copy_env_loop310
end_copy_env_loop310:

add_zero_rib_params310:
mov rcx, [rbp + 8 * 3]
shl rcx, 3 ; number of params * 8 bytes
MALLOC rcx, rcx
mov qword [rdx + 8 * 0], rcx
...
copy_params_loop310:
cmp rdi, [rbp + 8 * 3]
je end_copy_params_loop310
mov rbx, [rbp + 8 * (4 + rdi)]
mov qword [rcx + 8 * rdi], rbx
inc rdi
jmp copy_params_loop310
end_copy_params_loop310:
MAKE_CLOSURE(rax, rdx, Lcode310)
jmp Lcont310
Lcode310:
push rbp
mov rbp , rsp
...
mov rcx, [rbp + 8 * 3] ; Number of args on stack
cmp rbx, rcx
je add_nil_to_stack310

adjust_stack_to_list310:
mov rsi, [rbp + 8 * 3]
sub rsi, 0
sub rsi, 1 ; rsi holds the amount of blocks we need to push later
mov rax, SOB_NIL_ADDRESS ; cdr
...
mov rdx, 0
cmp rdx, 0
jne params_length_not_zero310
mov rdx, 1
jmp decided_param_count310
params_length_not_zero310:
mov rdx, rcx
sub rdx, 0
add rdx, 1
decided_param_count310:
mov qword [rbp + 8 * 3], rdx ; updating number of params on stack
dec rcx
add rcx, 4 ; rcx has the offset of the last arg
shl rcx, 3 ; 8*
...
create_list_loop310:
cmp rdi, 0
je end_create_list_loop310
mov rbx, qword [rcx] ; car
MAKE_PAIR(rdx, rbx, rax) ; rdx has new list
mov rax, rdx ; now rax has it ^
sub rcx, 8
dec rdi
jmp create_list_loop310
end_create_list_loop310:
pop rcx ; rcx now points to the last argument on stack
mov qword [rcx], rax ; new list is now in the correct place
; now lets push the stack up
mov rdx, qword [rbp + 8 * 3]
...
push_stack_loop310:
cmp rdi, 0
je end_push_stack_loop310
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
dec rdi
jmp push_stack_loop310
end_push_stack_loop310:
shl rsi, 3 ; push rbp and rsp up
add rbp, rsi
add rsp, rsi
jmp body310
...
mov rcx, [rbp + 8 * 3] ; Number of args on stack
cmp rbx, rcx
je add_nil_to_stack312

adjust_stack_to_list312:
mov rsi, [rbp + 8 * 3]
sub rsi, 0
sub rsi, 1 ; rsi holds the amount of blocks we need to push later
mov rax, SOB_NIL_ADDRESS ; cdr
...
mov rdx, 0
cmp rdx, 0
jne params_length_not_zero312
mov rdx, 1
jmp decided_param_count312
params_length_not_zero312:
mov rdx, rcx
sub rdx, 0
add rdx, 1
decided_param_count312:
mov qword [rbp + 8 * 3], rdx ; updating number of params on stack
dec rcx
add rcx, 4 ; rcx has the offset of the last arg
shl rcx, 3 ; 8*
...
create_list_loop312:
cmp rdi, 0
je end_create_list_loop312
mov rbx, qword [rcx] ; car
MAKE_PAIR(rdx, rbx, rax) ; rdx has new list
mov rax, rdx ; now rax has it ^
sub rcx, 8
dec rdi
jmp create_list_loop312
end_create_list_loop312:
pop rcx ; rcx now points to the last argument on stack
mov qword [rcx], rax ; new list is now in the correct place
; now lets push the stack up
mov rdx, qword [rbp + 8 * 3]
...
push_stack_loop312:
cmp rdi, 0
je end_push_stack_loop312
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
dec rdi
jmp push_stack_loop312
end_push_stack_loop312:
shl rsi, 3 ; push rbp and rsp up
add rbp, rsi
add rsp, rsi
jmp body312
...
mov rcx, [rbp + 8 * 3] ; Number of args on stack
cmp rbx, rcx
je add_nil_to_stack314

adjust_stack_to_list314:
mov rsi, [rbp + 8 * 3]
sub rsi, 0
sub rsi, 1 ; rsi holds the amount of blocks we need to push later
mov rax, SOB_NIL_ADDRESS ; cdr
...
mov rdx, 0
cmp rdx, 0
jne params_length_not_zero314
mov rdx, 1
jmp decided_param_count314
params_length_not_zero314:
mov rdx, rcx
sub rdx, 0
add rdx, 1
decided_param_count314:
mov qword [rbp + 8 * 3], rdx ; updating number of params on stack
dec rcx
add rcx, 4 ; rcx has the offset of the last arg
shl rcx, 3 ; 8*
...
create_list_loop314:
cmp rdi, 0
je end_create_list_loop314
mov rbx, qword [rcx] ; car
MAKE_PAIR(rdx, rbx, rax) ; rdx has new list
mov rax, rdx ; now rax has it ^
sub rcx, 8
dec rdi
jmp create_list_loop314
end_create_list_loop314:
pop rcx ; rcx now points to the last argument on stack
mov qword [rcx], rax ; new list is now in the correct place
; now lets push the stack up
mov rdx, qword [rbp + 8 * 3]
...
push_stack_loop314:
cmp rdi, 0
je end_push_stack_loop314
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
dec rdi
jmp push_stack_loop314
end_push_stack_loop314:
shl rsi, 3 ; push rbp and rsp up
add rbp, rsi
add rsp, rsi
jmp body314
...
mov rbx, [rbp + 8 * 2]
cmp rbx, SOB_NIL_ADDRESS
je add_zero_rib_params316

mov rsi, 0 ; i=0
mov rdi, 1 ; j=1
copy_env_loop316:
cmp rsi, 10
je end_copy_env_loop316
mov rcx, [rbx + 8 * rsi]
mov qword [rdx + 8 * rdi], rcx
inc rsi
inc rdi
jmp copy_env_loop316
end_copy_env_loop316:

add_zero_rib_params316:
mov rcx, [rbp + 8 * 3]
shl rcx, 3 ; number of params * 8 bytes
MALLOC rcx, rcx
mov qword [rdx + 8 * 0], rcx
...
copy_params_loop316:
cmp rdi, [rbp + 8 * 3]
je end_copy_params_loop316
mov rbx, [rbp + 8 * (4 + rdi)]
mov qword [rcx + 8 * rdi], rbx
inc rdi
jmp copy_params_loop316
end_copy_params_loop316:
MAKE_CLOSURE(rax, rdx, Lcode316)
jmp Lcont316
Lcode316:
push rbp
mov rbp , rsp
...
mov rcx, [rbp + 8 * 3] ; Number of args on stack
cmp rbx, rcx
je add_nil_to_stack316

adjust_stack_to_list316:
mov rsi, [rbp + 8 * 3]
sub rsi, 0
sub rsi, 1 ; rsi holds the amount of blocks we need to push later
mov rax, SOB_NIL_ADDRESS ; cdr
...
mov rdx, 0
cmp rdx, 0
jne params_length_not_zero316
mov rdx, 1
jmp decided_param_count316
params_length_not_zero316:
mov rdx, rcx
sub rdx, 0
add rdx, 1
decided_param_count316:
mov qword [rbp + 8 * 3], rdx ; updating number of params on stack
dec rcx
add rcx, 4 ; rcx has the offset of the last arg
shl rcx, 3 ; 8*
...
create_list_loop316:
cmp rdi, 0
je end_create_list_loop316
mov rbx, qword [rcx] ; car
MAKE_PAIR(rdx, rbx, rax) ; rdx has new list
mov rax, rdx ; now rax has it ^
sub rcx, 8
dec rdi
jmp create_list_loop316
end_create_list_loop316:
pop rcx ; rcx now points to the last argument on stack
mov qword [rcx], rax ; new list is now in the correct place
; now lets push the stack up
mov rdx, qword [rbp + 8 * 3]
...
push_stack_loop316:
cmp rdi, 0
je end_push_stack_loop316
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
dec rdi
jmp push_stack_loop316
end_push_stack_loop316:
shl rsi, 3 ; push rbp and rsp up
add rbp, rsi
add rsp, rsi
jmp body316
...
mov rcx, [rbp + 8 * 3] ; Number of args on stack
cmp rbx, rcx
je add_nil_to_stack318

adjust_stack_to_list318:
mov rsi, [rbp + 8 * 3]
sub rsi, 0
sub rsi, 1 ; rsi holds the amount of blocks we need to push later
mov rax, SOB_NIL_ADDRESS ; cdr
...
mov rdx, 0
cmp rdx, 0
jne params_length_not_zero318
mov rdx, 1
jmp decided_param_count318
params_length_not_zero318:
mov rdx, rcx
sub rdx, 0
add rdx, 1
decided_param_count318:
mov qword [rbp + 8 * 3], rdx ; updating number of params on stack
dec rcx
add rcx, 4 ; rcx has the offset of the last arg
shl rcx, 3 ; 8*
...
create_list_loop318:
cmp rdi, 0
je end_create_list_loop318
mov rbx, qword [rcx] ; car
MAKE_PAIR(rdx, rbx, rax) ; rdx has new list
mov rax, rdx ; now rax has it ^
sub rcx, 8
dec rdi
jmp create_list_loop318
end_create_list_loop318:
pop rcx ; rcx now points to the last argument on stack
mov qword [rcx], rax ; new list is now in the correct place
; now lets push the stack up
mov rdx, qword [rbp + 8 * 3]
...
push_stack_loop318:
cmp rdi, 0
je end_push_stack_loop318
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
dec rdi
jmp push_stack_loop318
end_push_stack_loop318:
shl rsi, 3 ; push rbp and rsp up
add rbp, rsi
add rsp, rsi
jmp body318
...
mov rbx, [rbp + 8 * 2]
cmp rbx, SOB_NIL_ADDRESS
je add_zero_rib_params320

mov rsi, 0 ; i=0
mov rdi, 1 ; j=1
copy_env_loop320:
cmp rsi, 12
je end_copy_env_loop320
mov rcx, [rbx + 8 * rsi]
mov qword [rdx + 8 * rdi], rcx
inc rsi
inc rdi
jmp copy_env_loop320
end_copy_env_loop320:

add_zero_rib_params320:
mov rcx, [rbp + 8 * 3]
shl rcx, 3 ; number of params * 8 bytes
MALLOC rcx, rcx
mov qword [rdx + 8 * 0], rcx
...
copy_params_loop320:
cmp rdi, [rbp + 8 * 3]
je end_copy_params_loop320
mov rbx, [rbp + 8 * (4 + rdi)]
mov qword [rcx + 8 * rdi], rbx
inc rdi
jmp copy_params_loop320
end_copy_params_loop320:
...
mov rcx, [rbp + 8 * 3] ; Number of args on stack
cmp rbx, rcx
je add_nil_to_stack320

adjust_stack_to_list320:
mov rsi, [rbp + 8 * 3]
sub rsi, 0
sub rsi, 1 ; rsi holds the amount of blocks we need to push later
mov rax, SOB_NIL_ADDRESS ; cdr
...
mov rdx, 0
cmp rdx, 0
jne params_length_not_zero320
mov rdx, 1
jmp decided_param_count320
params_length_not_zero320:
mov rdx, rcx
sub rdx, 0
add rdx, 1
decided_param_count320:
mov qword [rbp + 8 * 3], rdx ; updating number of params on stack
dec rcx
add rcx, 4 ; rcx has the offset of the last arg
shl rcx, 3 ; 8*
...
create_list_loop320:
cmp rdi, 0
je end_create_list_loop320
mov rbx, qword [rcx] ; car
MAKE_PAIR(rdx, rbx, rax) ; rdx has new list
mov rax, rdx ; now rax has it ^
sub rcx, 8
dec rdi
jmp create_list_loop320
end_create_list_loop320:
pop rcx ; rcx now points to the last argument on stack
mov qword [rcx], rax ; new list is now in the correct place
; now lets push the stack up
mov rdx, qword [rbp + 8 * 3]
...
push_stack_loop320:
cmp rdi, 0
je end_push_stack_loop320
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
dec rdi
jmp push_stack_loop320
end_push_stack_loop320:
shl rsi, 3 ; push rbp and rsp up
add rbp, rsi
add rsp, rsi
jmp body320
...
mov rcx, [rbp + 8 * 3] ; Number of args on stack
cmp rbx, rcx
je add_nil_to_stack322

adjust_stack_to_list322:
mov rsi, [rbp + 8 * 3]
sub rsi, 0
sub rsi, 1 ; rsi holds the amount of blocks we need to push later
mov rax, SOB_NIL_ADDRESS ; cdr
...
mov rdx, 0
cmp rdx, 0
jne params_length_not_zero322
mov rdx, 1
jmp decided_param_count322
params_length_not_zero322:
mov rdx, rcx
sub rdx, 0
add rdx, 1
decided_param_count322:
mov qword [rbp + 8 * 3], rdx ; updating number of params on stack
dec rcx
add rcx, 4 ; rcx has the offset of the last arg
shl rcx, 3 ; 8*
...
create_list_loop322:
cmp rdi, 0
je end_create_list_loop322
mov rbx, qword [rcx] ; car
MAKE_PAIR(rdx, rbx, rax) ; rdx has new list
mov rax, rdx ; now rax has it ^
sub rcx, 8
dec rdi
jmp create_list_loop322
end_create_list_loop322:
pop rcx ; rcx now points to the last argument on stack
mov qword [rcx], rax ; new list is now in the correct place
; now lets push the stack up
mov rdx, qword [rbp + 8 * 3]
...
push_stack_loop322:
cmp rdi, 0
je end_push_stack_loop322
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
dec rdi
jmp push_stack_loop322
end_push_stack_loop322:
shl rsi, 3 ; push rbp and rsp up
add rbp, rsi
add rsp, rsi
jmp body322
...
mov rcx, [rbp + 8 * 3] ; Number of args on stack
cmp rbx, rcx
je add_nil_to_stack324

adjust_stack_to_list324:
mov rsi, [rbp + 8 * 3]
sub rsi, 0
sub rsi, 1 ; rsi holds the amount of blocks we need to push later
mov rax, SOB_NIL_ADDRESS ; cdr
...
mov rdx, 0
cmp rdx, 0
jne params_length_not_zero324
mov rdx, 1
jmp decided_param_count324
params_length_not_zero324:
mov rdx, rcx
sub rdx, 0
add rdx, 1
decided_param_count324:
mov qword [rbp + 8 * 3], rdx ; updating number of params on stack
dec rcx
add rcx, 4 ; rcx has the offset of the last arg
shl rcx, 3 ; 8*
...
create_list_loop324:
cmp rdi, 0
je end_create_list_loop324
mov rbx, qword [rcx] ; car
MAKE_PAIR(rdx, rbx, rax) ; rdx has new list
mov rax, rdx ; now rax has it ^
sub rcx, 8
dec rdi
jmp create_list_loop324
end_create_list_loop324:
pop rcx ; rcx now points to the last argument on stack
mov qword [rcx], rax ; new list is now in the correct place
; now lets push the stack up
mov rdx, qword [rbp + 8 * 3]
...
push_stack_loop324:
cmp rdi, 0
je end_push_stack_loop324
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
dec rdi
jmp push_stack_loop324
end_push_stack_loop324:
shl rsi, 3 ; push rbp and rsp up
add rbp, rsi
add rsp, rsi
jmp body324
...
mov rcx, [rbp + 8 * 3] ; Number of args on stack
cmp rbx, rcx
je add_nil_to_stack326

adjust_stack_to_list326:
mov rsi, [rbp + 8 * 3]
sub rsi, 0
sub rsi, 1 ; rsi holds the amount of blocks we need to push later
mov rax, SOB_NIL_ADDRESS ; cdr
...
mov rdx, 0
cmp rdx, 0
jne params_length_not_zero326
mov rdx, 1
jmp decided_param_count326
params_length_not_zero326:
mov rdx, rcx
sub rdx, 0
add rdx, 1
decided_param_count326:
mov qword [rbp + 8 * 3], rdx ; updating number of params on stack
dec rcx
add rcx, 4 ; rcx has the offset of the last arg
shl rcx, 3 ; 8*
...
create_list_loop326:
cmp rdi, 0
je end_create_list_loop326
mov rbx, qword [rcx] ; car
MAKE_PAIR(rdx, rbx, rax) ; rdx has new list
mov rax, rdx ; now rax has it ^
sub rcx, 8
dec rdi
jmp create_list_loop326
end_create_list_loop326:
pop rcx ; rcx now points to the last argument on stack
mov qword [rcx], rax ; new list is now in the correct place
; now lets push the stack up
mov rdx, qword [rbp + 8 * 3]
...
push_stack_loop326:
cmp rdi, 0
je end_push_stack_loop326
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
dec rdi
jmp push_stack_loop326
end_push_stack_loop326:
shl rsi, 3 ; push rbp and rsp up
add rbp, rsi
add rsp, rsi
jmp body326
...
mov rbx, [rbp + 8 * 2]
cmp rbx, SOB_NIL_ADDRESS
je add_zero_rib_params328

mov rsi, 0 ; i=0
mov rdi, 1 ; j=1
copy_env_loop328:
cmp rsi, 16
je end_copy_env_loop328
mov rcx, [rbx + 8 * rsi]
mov qword [rdx + 8 * rdi], rcx
inc rsi
inc rdi
jmp copy_env_loop328
end_copy_env_loop328:

add_zero_rib_params328:
mov rcx, [rbp + 8 * 3]
shl rcx, 3 ; number of params * 8 bytes
MALLOC rcx, rcx
mov qword [rdx + 8 * 0], rcx
...
copy_params_loop328:
cmp rdi, [rbp + 8 * 3]
je end_copy_params_loop328
mov rbx, [rbp + 8 * (4 + rdi)]
mov qword [rcx + 8 * rdi], rbx
inc rdi
jmp copy_params_loop328
end_copy_params_loop328:
...
mov rcx, [rbp + 8 * 3] ; Number of args on stack
cmp rbx, rcx
je add_nil_to_stack328

adjust_stack_to_list328:
mov rsi, [rbp + 8 * 3]
sub rsi, 0
sub rsi, 1 ; rsi holds the amount of blocks we need to push later
mov rax, SOB_NIL_ADDRESS ; cdr
...
mov rdx, 0
cmp rdx, 0
jne params_length_not_zero328
mov rdx, 1
jmp decided_param_count328
params_length_not_zero328:
mov rdx, rcx
sub rdx, 0
add rdx, 1
decided_param_count328:
mov qword [rbp + 8 * 3], rdx ; updating number of params on stack
dec rcx
add rcx, 4 ; rcx has the offset of the last arg
shl rcx, 3 ; 8*
...
create_list_loop328:
cmp rdi, 0
je end_create_list_loop328
mov rbx, qword [rcx] ; car
MAKE_PAIR(rdx, rbx, rax) ; rdx has new list
mov rax, rdx ; now rax has it ^
sub rcx, 8
dec rdi
jmp create_list_loop328
end_create_list_loop328:
pop rcx ; rcx now points to the last argument on stack
mov qword [rcx], rax ; new list is now in the correct place
; now lets push the stack up
mov rdx, qword [rbp + 8 * 3]
...
push_stack_loop328:
cmp rdi, 0
je end_push_stack_loop328
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
dec rdi
jmp push_stack_loop328
end_push_stack_loop328:
shl rsi, 3 ; push rbp and rsp up
add rbp, rsi
add rsp, rsi
jmp body328
...
mov rcx, [rbp + 8 * 3] ; Number of args on stack
cmp rbx, rcx
je add_nil_to_stack330

adjust_stack_to_list330:
mov rsi, [rbp + 8 * 3]
sub rsi, 0
sub rsi, 1 ; rsi holds the amount of blocks we need to push later
mov rax, SOB_NIL_ADDRESS ; cdr
...
mov rdx, 0
cmp rdx, 0
jne params_length_not_zero330
mov rdx, 1
jmp decided_param_count330
params_length_not_zero330:
mov rdx, rcx
sub rdx, 0
add rdx, 1
decided_param_count330:
mov qword [rbp + 8 * 3], rdx ; updating number of params on stack
dec rcx
add rcx, 4 ; rcx has the offset of the last arg
shl rcx, 3 ; 8*
...
create_list_loop330:
cmp rdi, 0
je end_create_list_loop330
mov rbx, qword [rcx] ; car
MAKE_PAIR(rdx, rbx, rax) ; rdx has new list
mov rax, rdx ; now rax has it ^
sub rcx, 8
dec rdi
jmp create_list_loop330
end_create_list_loop330:
pop rcx ; rcx now points to the last argument on stack
mov qword [rcx], rax ; new list is now in the correct place
; now lets push the stack up
mov rdx, qword [rbp + 8 * 3]
...
push_stack_loop330:
cmp rdi, 0
je end_push_stack_loop330
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
dec rdi
jmp push_stack_loop330
end_push_stack_loop330:
shl rsi, 3 ; push rbp and rsp up
add rbp, rsi
add rsp, rsi
jmp body330
...
mov rbx, [rbp + 8 * 2]
cmp rbx, SOB_NIL_ADDRESS
je add_zero_rib_params332

mov rsi, 0 ; i=0
mov rdi, 1 ; j=1
copy_env_loop332:
cmp rsi, 18
je end_copy_env_loop332
mov rcx, [rbx + 8 * rsi]
mov qword [rdx + 8 * rdi], rcx
inc rsi
inc rdi
jmp copy_env_loop332
end_copy_env_loop332:

add_zero_rib_params332:
mov rcx, [rbp + 8 * 3]
shl rcx, 3 ; number of params * 8 bytes
MALLOC rcx, rcx
mov qword [rdx + 8 * 0], rcx
...
copy_params_loop332:
cmp rdi, [rbp + 8 * 3]
je end_copy_params_loop332
mov rbx, [rbp + 8 * (4 + rdi)]
mov qword [rcx + 8 * rdi], rbx
inc rdi
jmp copy_params_loop332
end_copy_params_loop332:
MAKE_CLOSURE(rax, rdx, Lcode332)
jmp Lcont332
Lcode332:
push rbp
mov rbp , rsp
...
mov rcx, [rbp + 8 * 3] ; Number of args on stack
cmp rbx, rcx
je add_nil_to_stack332

adjust_stack_to_list332:
mov rsi, [rbp + 8 * 3]
sub rsi, 0
sub rsi, 1 ; rsi holds the amount of blocks we need to push later
mov rax, SOB_NIL_ADDRESS ; cdr
...
mov rdx, 0
cmp rdx, 0
jne params_length_not_zero332
mov rdx, 1
jmp decided_param_count332
params_length_not_zero332:
mov rdx, rcx
sub rdx, 0
add rdx, 1
decided_param_count332:
mov qword [rbp + 8 * 3], rdx ; updating number of params on stack
dec rcx
add rcx, 4 ; rcx has the offset of the last arg
shl rcx, 3 ; 8*
...
create_list_loop332:
cmp rdi, 0
je end_create_list_loop332
mov rbx, qword [rcx] ; car
MAKE_PAIR(rdx, rbx, rax) ; rdx has new list
mov rax, rdx ; now rax has it ^
sub rcx, 8
dec rdi
jmp create_list_loop332
end_create_list_loop332:
pop rcx ; rcx now points to the last argument on stack
mov qword [rcx], rax ; new list is now in the correct place
; now lets push the stack up
mov rdx, qword [rbp + 8 * 3]
...
push_stack_loop332:
cmp rdi, 0
je end_push_stack_loop332
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
dec rdi
jmp push_stack_loop332
end_push_stack_loop332:
shl rsi, 3 ; push rbp and rsp up
add rbp, rsi
add rsp, rsi
jmp body332
...
copy_stack_loop329:
cmp rsi, 48
je end_copy_stack_loop329
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
add rsi, 8
jmp copy_stack_loop329
end_copy_stack_loop329:
add rsp, rdi
pop rbp
jmp rax
leave
...
copy_stack_loop327:
cmp rsi, 48
je end_copy_stack_loop327
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
add rsi, 8
jmp copy_stack_loop327
end_copy_stack_loop327:
add rsp, rdi
pop rbp
jmp rax
leave
...
copy_stack_loop321:
cmp rsi, 48
je end_copy_stack_loop321
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
add rsi, 8
jmp copy_stack_loop321
end_copy_stack_loop321:
add rsp, rdi
pop rbp
jmp rax
leave
...
copy_stack_loop319:
cmp rsi, 48
je end_copy_stack_loop319
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
add rsi, 8
jmp copy_stack_loop319
end_copy_stack_loop319:
add rsp, rdi
pop rbp
jmp rax
leave
...
copy_stack_loop317:
cmp rsi, 48
je end_copy_stack_loop317
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
add rsi, 8
jmp copy_stack_loop317
end_copy_stack_loop317:
add rsp, rdi
pop rbp
jmp rax
leave
...
copy_stack_loop315:
cmp rsi, 48
je end_copy_stack_loop315
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
add rsi, 8
jmp copy_stack_loop315
end_copy_stack_loop315:
add rsp, rdi
pop rbp
jmp rax
leave
...
copy_stack_loop313:
cmp rsi, 48
je end_copy_stack_loop313
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
add rsi, 8
jmp copy_stack_loop313
end_copy_stack_loop313:
add rsp, rdi
pop rbp
jmp rax
leave
...
copy_stack_loop311:
cmp rsi, 48
je end_copy_stack_loop311
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
add rsi, 8
jmp copy_stack_loop311
end_copy_stack_loop311:
add rsp, rdi
pop rbp
jmp rax
leave
...
copy_stack_loop307:
cmp rsi, 48
je end_copy_stack_loop307
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
add rsi, 8
jmp copy_stack_loop307
end_copy_stack_loop307:
add rsp, rdi
pop rbp
jmp rax
leave
...
copy_stack_loop305:
cmp rsi, 48
je end_copy_stack_loop305
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
add rsi, 8
jmp copy_stack_loop305
end_copy_stack_loop305:
add rsp, rdi
pop rbp
jmp rax
leave
...
copy_stack_loop301:
cmp rsi, 48
je end_copy_stack_loop301
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
add rsi, 8
jmp copy_stack_loop301
end_copy_stack_loop301:
add rsp, rdi
pop rbp
jmp rax
leave
...
copy_stack_loop297:
cmp rsi, 48
je end_copy_stack_loop297
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
add rsi, 8
jmp copy_stack_loop297
end_copy_stack_loop297:
add rsp, rdi
pop rbp
jmp rax
leave
...
copy_stack_loop295:
cmp rsi, 48
je end_copy_stack_loop295
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
add rsi, 8
jmp copy_stack_loop295
end_copy_stack_loop295:
add rsp, rdi
pop rbp
jmp rax
leave
