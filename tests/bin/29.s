...
MAKE_LITERAL_PAIR(const_tbl+51,const_tbl+136)
MAKE_LITERAL_RATIONAL(4,1)
MAKE_LITERAL_RATIONAL(5,1)
MAKE_LITERAL_RATIONAL(6,1)
MAKE_LITERAL_PAIR(const_tbl+204,const_tbl+1)
MAKE_LITERAL_PAIR(const_tbl+221,const_tbl+1)
MAKE_LITERAL_PAIR(const_tbl+187,const_tbl+238)
MAKE_LITERAL_PAIR(const_tbl+255,const_tbl+1)
MAKE_LITERAL_PAIR(const_tbl+170,const_tbl+272)
MAKE_LITERAL_RATIONAL(7,1)
MAKE_LITERAL_RATIONAL(8,1)
MAKE_LITERAL_PAIR(const_tbl+323,const_tbl+1)
MAKE_LITERAL_RATIONAL(9,1)
MAKE_LITERAL_RATIONAL(10,1)
MAKE_LITERAL_RATIONAL(11,1)
MAKE_LITERAL_RATIONAL(12,1)
MAKE_LITERAL_PAIR(const_tbl+408,const_tbl+1)
MAKE_LITERAL_PAIR(const_tbl+391,const_tbl+425)
MAKE_LITERAL_PAIR(const_tbl+374,const_tbl+442)
MAKE_LITERAL_PAIR(const_tbl+357,const_tbl+459)
MAKE_LITERAL_PAIR(const_tbl+340,const_tbl+476)
MAKE_LITERAL_PAIR(const_tbl+306,const_tbl+493)
MAKE_LITERAL_RATIONAL(13,1)
MAKE_LITERAL_PAIR(const_tbl+527,const_tbl+1)
MAKE_LITERAL_PAIR(const_tbl+510,const_tbl+544)
MAKE_LITERAL_RATIONAL(14,1)
MAKE_LITERAL_PAIR(const_tbl+578,const_tbl+1)
MAKE_LITERAL_PAIR(const_tbl+561,const_tbl+595)
MAKE_LITERAL_PAIR(const_tbl+612,const_tbl+1)
MAKE_LITERAL_PAIR(const_tbl+629,const_tbl+1)
MAKE_LITERAL_PAIR(const_tbl+646,const_tbl+1)
MAKE_LITERAL_PAIR(const_tbl+289,const_tbl+663)
MAKE_LITERAL_PAIR(const_tbl+153,const_tbl+680)
...
mov rbx, [rbp + 8 * 2]
cmp rbx, SOB_NIL_ADDRESS
je add_zero_rib_params293

mov rsi, 0 ; i=0
mov rdi, 1 ; j=1
copy_env_loop293:
cmp rsi, -1
je end_copy_env_loop293
mov rcx, [rbx + 8 * rsi]
mov qword [rdx + 8 * rdi], rcx
inc rsi
inc rdi
jmp copy_env_loop293
end_copy_env_loop293:

add_zero_rib_params293:
mov rcx, [rbp + 8 * 3]
shl rcx, 3 ; number of params * 8 bytes
MALLOC rcx, rcx
mov qword [rdx + 8 * 0], rcx
...
copy_params_loop293:
cmp rdi, [rbp + 8 * 3]
je end_copy_params_loop293
mov rbx, [rbp + 8 * (4 + rdi)]
mov qword [rcx + 8 * rdi], rbx
inc rdi
jmp copy_params_loop293
end_copy_params_loop293:
...
copy_stack_loop298:
cmp rsi, 48
je end_copy_stack_loop298
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
add rsi, 8
jmp copy_stack_loop298
end_copy_stack_loop298:
add rsp, rdi
pop rbp
jmp rax
leave
...
copy_stack_loop294:
cmp rsi, 48
je end_copy_stack_loop294
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
add rsi, 8
jmp copy_stack_loop294
end_copy_stack_loop294:
add rsp, rdi
pop rbp
jmp rax
leave
...
mov rbx, [rbp + 8 * 2]
cmp rbx, SOB_NIL_ADDRESS
je add_zero_rib_params307

mov rsi, 0 ; i=0
mov rdi, 1 ; j=1
copy_env_loop307:
cmp rsi, 0
je end_copy_env_loop307
mov rcx, [rbx + 8 * rsi]
mov qword [rdx + 8 * rdi], rcx
inc rsi
inc rdi
jmp copy_env_loop307
end_copy_env_loop307:

add_zero_rib_params307:
mov rcx, [rbp + 8 * 3]
shl rcx, 3 ; number of params * 8 bytes
MALLOC rcx, rcx
mov qword [rdx + 8 * 0], rcx
...
copy_params_loop307:
cmp rdi, [rbp + 8 * 3]
je end_copy_params_loop307
mov rbx, [rbp + 8 * (4 + rdi)]
mov qword [rcx + 8 * rdi], rbx
inc rdi
jmp copy_params_loop307
end_copy_params_loop307:
MAKE_CLOSURE(rax, rdx, Lcode307)
jmp Lcont307
Lcode307:
push rbp
mov rbp , rsp
...
copy_stack_loop322:
cmp rsi, 56
je end_copy_stack_loop322
mov rdx, qword [rbx]
mov qword [rcx], rdx
sub rbx, 8
sub rcx, 8
add rsi, 8
jmp copy_stack_loop322
end_copy_stack_loop322:
add rsp, rdi
pop rbp
jmp rax
jmp Lexit320
...
; ScmApplic': 
; ScmConst':
mov rax, const_tbl + 697

push rax
push 1
; ScmApplic': 
; ScmVar'(VarFree): depth
